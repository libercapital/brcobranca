  ...
  module Brpagamento
    module Remessa
      class Pagamento
        ...
        validates_presence_of :cod_banco, :tipo_movimento, :agencia, :conta_corrente, :digito_conta, :nome_favorecido, :documento_favorecido, :uso_da_empresa, :data_pagamento, :tipo_moeda, :valor, :finalidade_ted, :aviso_favorecido,
