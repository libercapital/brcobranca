    ...
    module Cnab400
      class Bradesco < Brcobranca::Remessa::Cnab400::Base
        ...
        def initialize(campos = {})
          campos = { condicao_emissao: '1', aviso_debito: '2', identificacao_registro: 'N' }.merge!(campos)
          super(campos)
        end
        ...
        def monta_documento_avalista(documento)
          ...
          when "01"
            documento.insert(9,'0000').format_size(15)
          when "02"
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << pagamento.cod_primeira_instrucao                 # 1a instrucao - deixar zero                  X[02]       157 a 158
          detalhe << prazo_instrucao(pagamento)                       # quantidade de dias do prazo                 9[02]       159 a 160
