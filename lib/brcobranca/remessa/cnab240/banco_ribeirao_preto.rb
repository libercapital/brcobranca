    ...
    module Cnab240
      class BancoRibeiraoPreto < Brcobranca::Remessa::Cnab240::Base
        ...
        def monta_segmento_p(pagamento, nro_lote, sequencial)
          ...
          segmento_p << pagamento.numero.to_s.ljust(15, ' ')                               # Número do Documento de Cobrança            [63....77] 15
          ...
          segmento_p << pagamento.documento.to_s.ljust(25, ' ')                            # Identificação do Título na Empresa         [196..220] 25
