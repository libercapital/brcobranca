    ...
    module Cnab444
      class Paulista < Brcobranca::Remessa::Cnab444::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << pagamento.coobrigacao.rjust(2, "0").format_size(2)                             # SIM 9(02) 01 =Com Coobrigação 02 = Sem Coobrigação
          detalhe << pagamento.caracteristica_especial.rjust(2, "0").format_size(2)               # Não 9(02) Preencher de acordo com o Anexo 8 do layout SRC3040 do Bacen
          detalhe << pagamento.modalidade_operacao.rjust(4, "0").format_size(4)                   # Não 9(04) Preencher de acordo com o Anexo 3 do layout SRC3040 do Bacen – preencher o domínio e o subdomínio
          detalhe << pagamento.natureza_operacao.rjust(2, "0").format_size(2)                     # Não 9(02) Preencher de acordo com o Anexo 2 do layout SRC3040 do Bacen
          detalhe << pagamento.origem_recurso.rjust(4, "0").format_size(4)                        # Não 9(04) Preencher de acordo com o Anexo 4 do layout SRC3040 do Bacen– preencher o domínio e o subdomínio
          detalhe << pagamento.classe_risco_operacao.ljust(2, " ").format_size(2)                 # Não X(02) Preencher de acordo com o Anexo 17 do layout SRC3040 do Bacen – preencher da esquerda para direita
          ...
          detalhe << identificacao_ocorrencia.rjust(2, "0").format_size(2)                        # Sim 9(02) Vide seção 4.1 números 23 do documento
          ...
          detalhe << pagamento.especie_titulo.rjust(2, "0").format_size(2)                          # Sim 9(02) Espécie de Título
          detalhe << "N".ljust(1, " ")                                                             # Não X(01) Branco identificacao
          detalhe << pagamento.data_emissao.strftime('%d%m%y').rjust(6, "0")                       # Sim 9(06) DDMMAA
          detalhe << primeira_instrucao.rjust(2, "0").format_size(2)                                 # Não 9(02) 1ª instrução
          detalhe << segunda_instrucao.rjust(1, "0").format_size(1)                                # Não 9(01) 2ª instrução
          detalhe << pagamento.identificacao_cedente(pagamento.documento_cedente).ljust(2, " ").format_size(2)  # SIM X(02) 01 - Pessoa Física;  02 - Pessoa Jurídica;
          ...
          detalhe << pagamento.identificacao_sacado(pagamento.documento_sacado).rjust(2, "0").format_size(2)  # Sim 9(02) 01-CPF 02-CNPJ
          detalhe << pagamento.documento_sacado.rjust(14, "0").format_size(14)                     # Sim 9(14) CNPJ/CPF
          ...
          detalhe << pagamento.n_serie_nota_fiscal.to_s.ljust(3, " ").format_size(3)               # Não X(03) Numero da Série da Nota Fiscal da Duplicata
          detalhe << pagamento.cep_sacado.rjust(8, "0").format_size(8)                            # Sim 9(08) CEP
          # detalhe << cedente.ljust(60, " ")                                                      # Sim X(60) Cedente
          detalhe << pagamento.nome_cedente.ljust(46, " ").format_size(46)                         # Sim X(46) Nome do Cedente
          detalhe << pagamento.documento_cedente.ljust(14, " ").format_size(14)                   # Sim X(14) CNPJ do Cedente
          detalhe << pagamento.chave_nota.to_s.ljust(44, " ").format_size(44)                     # Sim X(44) Chave da Nota Eletrônica
