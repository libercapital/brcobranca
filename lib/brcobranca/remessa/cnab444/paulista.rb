    ...
    module Cnab444
      class Paulista < Brcobranca::Remessa::Cnab444::Base
        ...
        def monta_detalhe(pagamento, sequencial)
          ...
          detalhe << pagamento.uso_da_empresa.ljust(25, " ")                            # Sim X(25) Nº de Controle do Participante
          ...
          detalhe << pagamento.nosso_numero.to_s.rjust(11, '0')                         # Não 9(11) Branco
          ...
          detalhe << "N".ljust(1, "0")                                                  # Não 9(01) Branco n = Banco não emite condicao_emissao
          detalhe << "".ljust(1, " ")                                                   # Não X(01) Branco
          ...
          detalhe << pagamento.numero_documento.ljust(10, " ")                          # Sim X(10) Nº do Documento
          ...
          detalhe << pagamento.numero_termo_cessao.ljust(19, " ")                       # Sim X(19) Conforme número enviado pela consultoria (campos alfa-numéricos)
          ...
          detalhe << pagamento.documento_sacado.rjust(11, "0")                          # Sim 9(14) CNPJ/CPF
          detalhe << pagamento.nome_sacado.ljust(40, " ")                               # Sim X(40) Nome do Sacado
          detalhe << pagamento.formata_endereco_sacado(pagamento).ljust(40, " ")                  # Sim X(40) Endereço Completo
          detalhe << pagamento.n_nota_fiscal.rjust(9, "0")                              # Sim X(09) Numero da Nota Fiscal da Duplicata
          detalhe << pagamento.n_serie_nota_fiscal.ljust(3, " ")                        # Não X(03) Numero da Série da Nota Fiscal da Duplicata
          detalhe << pagamento.cep_sacado.rjust(8, "0")                                 # Sim 9(08) CEP
          # detalhe << cedente.ljust(60, " ")                                           # Sim X(60) Cedente
          detalhe << pagamento.nome_cedente.ljust(46, " ")                              # Sim X(46) Nome do Cedente
          detalhe << pagamento.documento_cedente.ljust(14, " ")                         # Sim X(14) CNPJ do Cedente
          detalhe << pagamento.chave_nota.ljust(44, " ")                                # Sim X(44) Chave da Nota Eletrônica
